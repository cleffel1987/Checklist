...
namespace CheckList.Data.Migrations
{
    ...
    [Migration("20201019213616_TaskGroupCompleteCheck")]
    partial class TaskGroupCompleteCheck
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CheckList.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CheckList.Models.Task", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CheckList.Models.TaskGroup", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CheckList.Models.Task", b =>
                {
                    b.HasOne("CheckList.Models.ApplicationUser", "AddByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CheckList.Models.ApplicationUser", null)
                        .WithMany()
